...
checkpoint = torch.load("../storage/miner_deberta_first_claims_epoch_1_train_loss_0.04917613631956766_val_loss_0.10339764724347457.pt")
print("loading miner_deberta_first_claims_epoch_1_train_loss_0.04917613631956766_val_loss_0.10339764724347457.pt.pt")
...
for epoch_i in tqdm(range(epochs), desc="Epochs", position=0, leave=True, total=epochs):
    ...
    with tqdm(train_dataloader, unit="batch") as tepoch:
        for step, batch in enumerate(tepoch):
            if step%500==0 and step > 0:
                ...
                torch.save(model.state_dict(), "../storage/continued_miner_deberta_first_claims_epoch_{}_steps_{}_val_loss_{}.pt".format(epoch_i+1, step, avg_val_loss))
    ...
    print("saving checkpoint")  
    torch.save(model.state_dict(), "../storage/continued_miner_deberta_first_claims_epoch_{}_train_loss_{}_val_loss_{}.pt".format(epoch_i+1, avg_train_loss, avg_val_loss)) 
