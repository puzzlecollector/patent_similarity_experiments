...
train_dataloader = DataLoader(train_set, batch_size=38, num_workers=4, collate_fn=collate_metric_learning, shuffle=True)
validation_dataloader = DataLoader(valid_set, batch_size=38, num_workers=4, collate_fn=collate, shuffle=False) 
