...
checkpoint = torch.load("../storage/ipc_title_firstclaims_epoch_2_steps_6000_val_loss_0.13378801833644857.pt")
print("loading ipc_title_firstclaims_epoch_2_steps_6000_val_loss_0.13378801833644857.pt")
...
for epoch_i in tqdm(range(epochs), desc="Epochs", position=0, leave=True, total=epochs):
    ...
    with tqdm(train_dataloader, unit="batch") as tepoch:
        for step, batch in enumerate(tepoch):
            if step%1000==0 and step > 0:
                ...
                torch.save(model.state_dict(), "../storage/continued_ipc_title_firstclaims_epoch_{}_steps_{}_val_loss_{}.pt".format(epoch_i+1, step, avg_val_loss))
    ...
    print("saving checkpoint")  
    torch.save(model.state_dict(), "../storage/continued_ipc_title_firstclaims_epoch_{}_train_loss_{}_val_loss_{}.pt".format(epoch_i+1, avg_train_loss, avg_val_loss)) 
