...
for idx in range(len(ckpts)):
    ...
    train_x = train_df[['쿼리 문장', '후보 문장']].values 
    train_y = train_df['라벨링'].values 
    ...
    for i in range(len(train_y)):
        cat_y.append(cat_dict[train_y[i]]) 
    train_x, valid_x, train_y, valid_y = train_test_split(train_x, train_y, test_size=0.1, stratify=cat_y, random_state=42)  
