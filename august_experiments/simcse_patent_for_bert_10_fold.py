...
for idx, (train_idxs, val_idxs) in enumerate(cv.split(queries, cat_labels, query_no)): 
    ...
    model = SentenceTransformer("../storage/simcse_patent_for_bert") 
    ...
    model.fit(train_objectives=[(train_dataloader, train_loss)], 
              ...
              output_path="../storage/simcse_patent_for_bert_KFOLD{}".format(idx+1)) 
    
    # calculate val loss and val accuracy 
    print("load best model") 
    best_model = SentenceTransformer("../storage/simcse_patent_for_bert_KFOLD{}".format(idx+1)) 
