...
checkpoint = torch.load("../storage/miner_deberta_first_claims_checkpoint_epoch_1_steps_15000.pt")
print("loading miner_deberta_first_claims_checkpoint_epoch_1_steps_15000.pt")
model.load_state_dict(checkpoint) 
model.cuda()

accumulation_steps = 10 # simulate batch size of 530 
...
for epoch_i in tqdm(range(epochs), desc="Epochs", position=0, leave=True, total=epochs):
    ...
    with tqdm(train_dataloader, unit="batch") as tepoch:
        for step, batch in enumerate(tepoch):
            ...
            if step%3000==0 and step > 0:
                ...
                torch.save(model.state_dict(), "../storage/miner_deberta_first_claims_checkpoint_epoch_{}_steps_{}.pt".format(epoch_i+1, step)) 
            ''' 
    ...
    torch.save(model.state_dict(), "../storage/miner_deberta_first_claims_epoch_{}_train_loss_{}_val_loss_{}.pt".format(epoch_i+1, avg_train_loss, avg_val_loss)) 
