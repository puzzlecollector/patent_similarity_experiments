...
for epoch_i in tqdm(range(epochs), desc="Epochs", position=0, leave=True, total=epochs):
    ...
    with tqdm(train_dataloader, unit="batch") as tepoch:
        for step, batch in enumerate(tepoch):
            if step%5000==0 and step > 0:
                ...
                torch.save(model.state_dict(), "../storage/DEBERTA_Ranker_v4_intermediate_checkpoint_epoch_{}_steps_{}.pt".format(epoch_i+1, step)) 
    ...
    torch.save(model.state_dict(), "../storage/DEBERTA_Ranker_v4_epoch_{}_train_loss_{}_val_loss_{}.pt".format(epoch_i+1, avg_train_loss, avg_val_loss))  
