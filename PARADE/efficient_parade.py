...
class custom_collate(object):
    ...
    def chunk_tokens(self, tokens, start_token_id, end_token_id, overlap=50, chunk_size=512):
    ...
    def get_chunked(self, t, seq_len = 2, window_size = 512):
...
train_dataloader = DataLoader(train_set, batch_size=8, num_workers=4, collate_fn=collate, shuffle=True)
validation_dataloader = DataLoader(valid_set, batch_size=8, num_workers=4, collate_fn=collate, shuffle=False) 
...
accumulation_steps = 128 # simulate batch size of 1024 
