...
model_pt_path = Path("epoch_end_checkpoints-epoch=01-val_loss=0.21802041.ckpt")  
emb_dim = 768
output_dir = Path("../storage/embeddings") 
debug = False 
