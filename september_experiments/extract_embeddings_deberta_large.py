...
data_path = Path("./FGH_spec_ind_claim_triplet_v1.4.1s/")
model_pt_path = Path("./checkpoint/v1.4.1s_experiments/DeBERTa_Large/MultiSimilarityLoss/epoch_end_checkpoints-epoch=00-val_loss=0.20442404.ckpt")
emb_dim = 768
output_dir = Path("./DeBERTa_Large_embeddings")
debug = False
