...
class custom_collate(object):
    ...
    def chunk_tokens(self, tokens, start_token_id, end_token_id, overlap=12, chunk_size=192):
...
if __name__ == "__main__":
    ...
    ckpt_callback = pl.callbacks.ModelCheckpoint(
        ...
        filename="[data:spec_space_separated]_[model:deberta_base_spec_1024]_[method:cls]-{epoch:02d}-{train_loss:.8f}-{val_loss:.8f}",
        save_top_k=3,
        mode="min",
    )
